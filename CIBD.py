...
print("Output Config: <{},{},{},{},{},{}>".format(int(q1*180/np.pi), int(q2*180/np.pi), int(q3*180/np.pi), int(q4*180/np.pi), int(q5*180/np.pi), int(q6*180/np.pi)))
